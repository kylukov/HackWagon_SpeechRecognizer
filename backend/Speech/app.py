...
from skills import number, comment, dataframe, index
...
def recognize(data, vectorizer, clf):
    ...
    exec(func_name + '(data)')
#еправильно работает если 561 57 написа
 #ОШИБКИ
    # в mistake и next неправильно работают цифры
    #неправильно работает сашин алгоритм
def check(old,new,data):
...
def main():
    ...
    del words.data_set
    print('удалили слова; обучили модель')
    ...
    with sd.RawInputStream(samplerate=samplerate, blocksize = 48000, device=device[0], dtype='int16',
        ...
        while True:
            ...
            if rec.AcceptWaveform(data):
                ...
                a=change(str(rec.PartialResult())[17:-3])
                check(temp,a,data)
                temp=a
